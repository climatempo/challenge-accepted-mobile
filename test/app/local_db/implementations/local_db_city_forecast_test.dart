...
void main() {
  test('local db city forecast ...', () async {
    SharedPreferences.setMockInitialValues({'CITYFORECASTKEY': _json});
    final cityForecast = LocalDbCityForecastImp();

    var map = await cityForecast.fetchCityForecast();
  ...
  test('save city forecast', () async {
    SharedPreferences.setMockInitialValues({'CITYFORECASTKEY': _json});
    final cityForecast = LocalDbCityForecastImp();
    var map = cityForecast.saveCityForecast(jsonDecode(_json));
